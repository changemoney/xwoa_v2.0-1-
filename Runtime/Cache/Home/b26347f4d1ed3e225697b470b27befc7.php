	...
	<ul>
		<li class="thead" style="padding-left:10px">
			<div class="pull-left">
				...
				<span class="col-12 " align=center>类型</span>		
			</div>
			<div class="pull-right">
			    <span  class="col-18" align=center style="padding-right:10px">银行名称</span>
			...
			<ul>
			    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><li class="tbody">
						<div class="pull-left">
							...
							<span class="col-12" align=center> <?php echo ($vo["pay_type"]); ?></span>
						</div>
						<div class="pull-right">
						    <span class="col-18" align=center style="padding-right:10px"><?php echo ($vo["pay_bank"]); ?></span>
