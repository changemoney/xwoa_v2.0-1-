			...
			<form id="form_data" name="form_data" method="post" class="form-horizontal">
				...
				<table class="table table-bordered" >
					<tr>
						...
						<td rowspan="3" class="col-20"><img class="img-thumbnail col-12" id="emp_pic" src="/<?php echo (get_emp_pic($vo["id"])); ?>?t=<?php echo time();?>" onerror="javascript:this.src='/Uploads/emp_pic/no_avatar.jpg'"></td>
					</tr>
					<tr>
						<th>姓名</th>
						<td colspan="2">
