...
<?php if(!empty($plugin["calendar"])): ?><link href="/Public/Ins/css/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
	...
	<?php echo W('PageHeader/simple',array('name'=>'新建流程类型','search'=>'N'));?>
	<form method='post' id="form_data" class="well form-horizontal">
		...
		<div class="form-group col-sm-6">
			...
			<div class="col-sm-8">
				<input class="form-control" type="text" id="doc_no_format" name="doc_no_format" check="require" msg="请输入编号规则">
			</div>
		</div>
