...
<div class="ul_table ul_table_responsive">
	...
	<?php if(empty($list)): ?><ul>
		...
		<form method="post" action="" name="form_data" id="form_data">
			<ul>
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li class="tbody <?php if(($folder) == "receive"): echo get_flow_receive_is_read($vo['id']); endif; ?>">
						<div class="pull-left">
							<span class="col-13 "><?php echo ($vo["doc_no"]); ?></span>
							<span class="col-13  "> <?php echo ($vo["type_name"]); ?></span>
						</div>
						<div class="pull-right">
