...
<?php if(!empty($plugin["calendar"])): ?><link href="/Public/Ins/css/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
	...
	<form class="well form-horizontal" method='post' id="form_send" name="form_send" enctype="multipart/form-data">
				...
				<div id="recever" class="inputbox">
					...
					<div class="wrap" >
						<span class="address_list">
							<?php if(($type) == "reply"): echo (show_contact($vo["from"],"edit")); endif; ?>
							<?php if(($type) == "all"): echo (show_contact($vo["from"],"edit")); echo (show_contact($vo["to"],"edit")); endif; ?></span>
						<span class="text" >
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<div id="carbon_copy" class="inputbox">
					<div class="wrap" >
						<span class="address_list">
							<?php if(($type) == "all"): echo (show_contact($vo["cc"],"edit")); endif; ?></span>
						<span class="text" >
							<input class="letter" type="text"  >
						</span>
					</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input class="form-control"  type="text" name="name" id="mail_title"  check="require" msg="请输入标题" value="<?php echo ($prefix); ?>&nbsp;<?php echo ($vo["name"]); ?>">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="col-xs-12">
				<textarea  class="editor" id="content" name="content" class="col-xs-12">						</br></br></br></br>
						...
						<div style="background-color: #b6e3fc;">
							<p style="line-height:18px;padding-top:3px;">
								<b>&nbsp;发件人：</b><?php echo (show_contact($vo["from"])); ?>
							</p>
							<p style="line-height:18px;">
								<b>&nbsp;日期：</b><?php echo (to_date($vo["create_time"],'Y年m月d日 H:i')); ?>
							</p>
							<p style="line-height:18px;">
								<b>&nbsp;收件人：</b><?php echo (show_contact($vo["to"])); ?>
							</p>
							<?php if((strlen($vo["cc"])) > "2"): ?><p style="line-height:18px;">
									<b>&nbsp;抄送：</b><?php echo (show_contact($vo["cc"])); ?>
								</p><?php endif; ?>
							<p style="line-height:18px;padding-bottom:3px;">
								<b>&nbsp;标题：</b><?php echo ($vo["name"]); ?>
							</p>
						</div>
					<?php echo ($vo["content"]); ?></textarea>
			</div>
		</div>
	</form>
