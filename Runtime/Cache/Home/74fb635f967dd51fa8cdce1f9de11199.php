...
<?php if(!empty($plugin["calendar"])): ?><link href="/Public/Ins/css/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
	...
	<?php echo W('PageHeader/simple',array('name'=>'导入用户','search'=>'N'));?>
	<form method='post' id="form_data" enctype="multipart/form-data">
		...
		<ol class="spaced">
			<li class="col-xs-12 line-height-32">
				<a class="btn btn-primary" href="/<?php echo C('TEMPLETE_PATH');?>/user.xls" target="_blank"><i class="fa fa-download"></i>下载Excel格式&nbsp;</a>
			</li>
			<li class="col-xs-12 line-height-32">
				按照Excel格式，整理用户信息，不要调整列循序
			</li>
			<li class="col-xs-12 line-height-32">
				选择要导入的文件&nbsp;
				<input style="height:42px" type="file" name="uploadfile" value="" class="form-control col-30">
			</li>
		</ol>
	</form>
	<div class="action ">
...
<script type="text/javascript">
	...
	<script type="text/javascript">
		function save() {
			sendForm("form_data", "<?php echo U('import');?>", "/index.php/Home/User");
		}
	</script>
